    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-solid" style="padding: 10px;">
                <h3>欢迎使用 Blog!</h3>
                <strong>简介</strong>
                <p>  Blog 是一个基于Laravel开发，支持markdown语法开源的简易博客。</p>
                <strong>开发者信息</strong>
                <p>Name : </p>
                <p>Email : 91@foxmail.com</p>
                <p>博客地址 : <a href="http://.cn" target="_blank"></a></p>
                <p>项目地址 : <a href="https://github.com/-peng/-blog" target="_blank">Github</a></p>
